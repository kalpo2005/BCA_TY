...
<body>
    ...
    <div>
          ...
          <asp:TextBox ID="TextBox1" runat="server" Height="24px" style="margin-top: 8px" 
               BackColor="#CCCCFF"></asp:TextBox>    
    </div>
    
    <div>
           <asp:Label ID="Label2" runat="server" Text="Password"></asp:Label><br />
          <asp:TextBox ID="TextBox2" runat="server" Height="24px" style="margin-top: 8px" 
               TextMode="Password" BackColor="#CCCCFF"></asp:TextBox>    
    </div>
    ...
    <div>
          ...
          <asp:TextBox ID="TextBox3" runat="server" Height="50px" style="margin-top: 8px" 
               ...
               Width="250px" BackColor="#CCCCFF"></asp:TextBox>    
    </div>
    ...
    <div>
          ...
          <asp:TextBox ID="TextBox4" runat="server" Height="24px" style="margin-top: 8px" 
               ReadOnly="True" BackColor="#CCCCFF">Read Only value !!!</asp:TextBox>    
    </div>
    ...
    <div>
          ...
          <asp:TextBox ID="TextBox5" runat="server" Height="24px" style="margin-top: 8px" 
               MaxLength="10" BackColor="#CCCCFF"></asp:TextBox>    
    </div>
      ...
      <div>
          ...
          <asp:TextBox ID="TextBox6" runat="server" Height="24px" style="margin-top: 8px" 
               MaxLength="0" Columns="5" Rows="0" BackColor="#CCCCFF"></asp:TextBox>    
    </div>
    
      <div>
           <asp:Label ID="Label7" runat="server" Text="rows"></asp:Label><br />
          <asp:TextBox ID="TextBox7" runat="server" style="margin-top: 8px" 
               MaxLength="0" Rows="3" TextMode="MultiLine" BackColor="#CCCCFF"></asp:TextBox>    
    </div>
