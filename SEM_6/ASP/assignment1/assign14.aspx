<%@ Page Language="C#" AutoEventWireup="true" CodeFile="assign14.aspx.cs" Inherits="assign14" %>
...
<body>
    ...
    <div>
        ...
        <asp:Label ID="Label1" runat="server" Text="CheckNmber For Plaindrome"></asp:Label>
        :<br />
