<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shirt.aspx.cs" Inherits="menupages_shirt" %>
    ...
    <asp:Menu ID="Menu1" runat="server" Orientation="Horizontal" 
        ...
        <Items>
            ...
            <asp:MenuItem Text="Men" Value="Men">
                <asp:MenuItem Selected="True" NavigateUrl="~/menupages/shirt.aspx" Text="Shirts" Value="Shirts">
                </asp:MenuItem>
