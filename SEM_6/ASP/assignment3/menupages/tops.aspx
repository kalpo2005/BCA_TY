<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tops.aspx.cs" Inherits="menupages_tops" %>
    ...
    <asp:Menu ID="Menu1" runat="server" Orientation="Horizontal" 
        ...
        <Items>
            ...
            <asp:MenuItem Text="Woman" Value="Woman">
                ...
                <asp:MenuItem Selected="True" NavigateUrl="~/menupages/tops.aspx" Text="Tops" Value="Tops">
                </asp:MenuItem>
