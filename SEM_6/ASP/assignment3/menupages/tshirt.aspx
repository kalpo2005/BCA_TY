<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tshirt.aspx.cs" Inherits="menupages_tshirt" %>
    ...
    <asp:Menu ID="Menu1" runat="server" Orientation="Horizontal" 
        ...
        <Items>
            ...
            <asp:MenuItem Text="Men" Value="Men">
                ...
                <asp:MenuItem Selected="True" NavigateUrl="~/menupages/tshirt.aspx" Text="T-Shirts" 
