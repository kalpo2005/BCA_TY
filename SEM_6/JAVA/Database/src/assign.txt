...
public class datashow {
    ...
    public static void main(String[] args) {
        ...
        t1.setBounds(80, 30, 120, 30);

        JTextField t2 = new JTextField();
        t2.setBounds(80, 80, 120, 30);

        JTextField t3 = new JTextField();
        t3.setBounds(80, 120, 120, 30);

        JButton insert = new JButton("Submit");
        insert.setBounds(20, 180, 120, 30);

        JButton update = new JButton("Update");
        update.setBounds(160, 180, 120, 30);

        JButton delete = new JButton("Delete");
        delete.setBounds(300, 180, 120, 30);

        JButton show = new JButton("Show Data");
        show.setBounds(20, 230, 120, 30);
